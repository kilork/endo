...
impl DnaRope {
    ...
    pub fn prepend(&mut self, mut prefix: DnaRope) {
        prefix
            ...
            .drain(..)
            .rev()
            .for_each(|subdna| self.dna.insert(0, subdna));
...
mod tests {
    ...
    fn next() {
        ...
        assert_eq!(
            as_vec,
            vec![
                &I, &C, &F, &P, &I, &C, &F, &P, &I, &I, &I, &P, &P, &F, &P, &P, &P, &P
            ]
        );
    ...
    fn index_pair() {
        ...
        check_index_pair(&DnaRope::from_raw(vec![
            vec![C, I, F, F, F],
            vec![],
            vec![],
            vec![],
